...
public class AnalizadorSintacticoTiny {
   ...
   private void E0() {
     switch(anticipo.clase()) {
         case MENOS: case NOT: case PAB: case IDEN: case NUMERO: case TRUE: case FALSE:
             E1();
             RE0();
             break;
         default:  errores.errorSintactico(anticipo.fila(),anticipo.clase(),
        		 							ClaseLexica.MENOS, ClaseLexica.NOT,
        		 							ClaseLexica.PAB, ClaseLexica.IDEN,
        		 							ClaseLexica.NUM, ClaseLexica.TRUE,
        		 							ClaseLexica.FALSE);                                    
     }  
   }
   private void RE0() {
      switch(anticipo.clase()) {
          ...
          case MENOS: 
        	  ...
        	  RE0();
             break;
          case PCE: case PCOMA: case EOF: break;
          default:    
   ...
   private void RE1() {
      switch(anticipo.clase()) {
	      ...
	      case OR: 
	    	  ...
	    	  E1();
	    	  break;
	      case MAS: case MENOS: case PCE: case PCOMA: case EOF: break;
	      default:    
	          errores.errorSintactico(anticipo.fila(),anticipo.clase(),
	                                  ClaseLexica.MAS,ClaseLexica.MENOS);                                              
  } 
   ...
   private void RE2() {
      switch(anticipo.clase()) {
	      case MENOR: case MAYOR: case MENORIGUAL: case MAYORIGUAL: case EQUIV: case NOEQUIV:
	    	  OP();
	    	  E3();
	    	  break;
	      case MAS: case MENOS: case PCE: case PCOMA: case EOF: break;
   ...
   private void E4() {
      switch(anticipo.clase()) {
	     ...
	     case NOT:
	    	 ...
	    	 E5();
	    	 break;
	     case PAB: case IDEN: case NUMERO: case TRUE: case FALSE:
	    	 E5();
	    	 break;
	     default:  errores.errorSintactico(anticipo.fila(),anticipo.clase(),
	    		 							ClaseLexica.POR, ClaseLexica.DIV,
   ...
   private void OP() {
     switch(anticipo.clase()) {
         ...
         case EQUIV: empareja(ClaseLexica.EQUIV); break;  
         case NOEQUIV: empareja(ClaseLexica.NOEQUIV); break;  
