...
\begin{enumerate}
  ...
  \end{itemize}
  \item Nombres de variable: $iden$ serán los identificadores de las variables que declaremos. Deberán empezar por una letra, y pueden contener letras, dígitos o subrayados (\_).
  \item Separadores: dispondremos de dos tipos, uno para separar la sección de declaraciones de la sección de instrucciones, y otro para separar las declaraciones o instrucciones entre ellas.
  \begin{itemize}
    \item $pcoma$: será el separador de declaraciones o instrucciones entre ellas mismas (;).
  ...
  \begin{enumerate}
    ...
    \begin{itemize}
      ...
      \item $menos$: operador de resta y menos unario (-).
    ...
    \item Paréntesis: modifican la prioridad de las operaciones entre $parAb$ ( $($ ) y $parCe$ ( $)$ ).
  \end{enumerate}
\end{enumerate}
