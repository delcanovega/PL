/* ConstructorASTTinyTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. ConstructorASTTinyTokenManager.java */
package constructorast;
import ast.*;

/** Token Manager. */
@SuppressWarnings("unused")public class ConstructorASTTinyTokenManager implements ConstructorASTTinyConstants {
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public ConstructorASTTinyTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public ConstructorASTTinyTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
