...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \end{itemize}
    \item Operador unitario: $neg$ (-) delante de una expresión numérica.
...
\begin{itemize}
  ...
  $$ parteDecimal \longrightarrow .digito*digitoPositivo $$
  $$ parteExponencial \longrightarrow (e|E) (+|-|\oslash) digito* $$
  %%\end{flalign}
  \item \textbf{Definiciones léxicas:}
  %%\begin{flalign}
  $$ iden \longrightarrow letra(letra|digito|\_)* $$
  $$ numero \longrightarrow digito* (\oslash|parteDecimal) (\oslash|parteExponencial) $$
  %%\end{flalign}
